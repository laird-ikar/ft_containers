...
/*   Updated: 2023/02/06 14:01:34 by bguyot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	template<class T, class Alloc>
	template<class T_it>
	vector<T, Alloc>::_iterator<T_it>::_iterator(const typename vector<T, Alloc>::template _iterator<T_it> &rht)
	{
		*this = rht;
	}
	...
	template<class T, class Alloc>
	template<class T_it>
	vector<T, Alloc>::_iterator<T_it>::_iterator(typename vector<T, Alloc>::template _iterator<T_it>::pointer ptr)
	{
		this->ptr = ptr;
	}
	...
	template<class T, class Alloc>
	template<class T_it>
	typename vector<T, Alloc>::template _iterator<T_it>::value_type &vector<T, Alloc>::template _iterator<T_it>::operator*(void)
	{
		return *(this->ptr);
	}
	...
	{
		vector<T, Alloc>::template _iterator<T_it> old(*this);
		++(*this);
		return (old);
	}
	...
	template<class T, class Alloc>
	template<class T_it>
	typename vector<T, Alloc>::template _iterator<T_it>::difference_type &vector<T, Alloc>::template _iterator<T_it>::operator-(
