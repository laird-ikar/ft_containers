...
/*   Updated: 2023/02/13 18:15:49 by bguyot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		std::cout << "priting v2 via begin() and end():" << std::endl;
...
// 		}
// 		std::cout << std::endl;
// 		ft::vector<int> v3(3, 7);
// 		std::cout << "priting v3 via begin() and end():" << std::endl;
// 		for (ft::vector<int>::iterator it = v3.begin() ; it != v3.end() ; it++)
// 		{
// 			std::cout << *it << "; ";
// 		}
// 		std::cout << std::endl;
// 		std::cout << "assigning v3 to v" << std::endl;
...
// 		}
// 		std::cout << std::endl;
// 		std::cout << "instering 42 at pos 21, 42 times" << std::endl;
// 		v.insert(v.begin() + 21, 42, 42);
// 		std::cout << "priting via begin() and end():" << std::endl;
// 		for (ft::vector<int>::iterator it = v.begin() ; it != v.end() ; it++)
// 		{
// 			std::cout << *it << "; ";
